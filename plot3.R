#
# plot3.R plots Energy Sub-metering (kitchen, laundry, and water heater) over 2 days
#
#
...
# directly to PNG file, the default is already 480x480 so no  need to explicitly specify. 
# Close the PNG file device. Plot is placed in "figure" directory.

png(file="figure/plot3.png")
plot(df$DateTime, df$V7, type="l", col="Black", xlab="", ylab="Energy sub metering")
points(df$DateTime, df$V8, type="l", col="Red")
points(df$DateTime, df$V9, type="l", col="Blue")
